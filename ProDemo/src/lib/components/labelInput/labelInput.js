...
* @Last Modified by:   卢旺
* @Last Modified time: 2017-03-04 18:36:14
* 文本组件，支持左侧带标题，右侧带箭头
* 用法：
...
class LabelInput extends React.Component{
    ...
    render(){
        let {b_isInput,b_right_two} = this.props;
        let e_labelEl = null;
        let s_classSet = "";
        ...
        if(b_isInput){
            ...
            e_labelEl = <div className={s_classSet} onClick={this.onClickHandler.bind(this)}>
                ...
                <input onChange={()=>this.onChangeHandler()} maxLength={this.props.maxLength||""} onBlur={()=>this.onBlur()} onInput={()=>this.onInput()} ref="inputRef" defaultValue={this.props.s_value || ""} type={this.props.s_inputType} placeholder={s_right} />
                {e_rightImg}
            </div>;
        }else{
            ...
            let spanRight = classSet(b_right_two?"base-ellipsis2":"base-ellipsis",{"base-fr":this.props.b_right},{"base-mR10":this.props.b_after});
