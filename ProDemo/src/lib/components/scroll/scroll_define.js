...
class Scroll extends React.Component{
    ...
    componentDidMount(){
        ...
        options['preventDefault_cancel'] = true;
...
/*            if(!b_hor){
        ...
        this.myScroll.on("beforeScrollStart",()=>{
            if(self.props.beforeScrollStart){
                self.props.beforeScrollStart();
            }
        });
        this.myScroll.on('scroll',function(){
            if(b_pullDown && !this.b_hideTopEl){
    ...
    render(){
        ...
        e_topEl = <TopEl i_scrollType={this.state.i_positiveUpType} b_hideTopEl={this.b_hideTopEl}/>;
        return (
            <div className={`scroll ${this.props.className ||""}`} style={this.props.style}>
